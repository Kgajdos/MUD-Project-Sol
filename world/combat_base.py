...
class CombatFailure(RuntimeError):
    """If an error happens in combat"""
    pass

class CombatBaseHandler(DefaultScript):
    """
    This should be created when combat starts. It 'ticks' the combat and
    tracks all sides of it.
    """
    ...
    def get_combat_summary(self, combatant):
        ...
        #include ourselves at the top of the list
        ...
        #Two allies and enemy columns should be centered vertically
...
class CombatActionStunt(CombatAction):
    ...
    def execute(self):
        ...
        is_success, _, txt = dice.opposed_saving_throw(
            attacker,
            defender,
